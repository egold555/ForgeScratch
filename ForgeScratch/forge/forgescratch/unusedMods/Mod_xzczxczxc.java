...
@Mod(modid = Mod_xzczxczxc.MOD_ID, name=Mod_xzczxczxc.MOD_NAME, version="1.0")
public class Mod_xzczxczxc {
	public static final String MOD_NAME = "xzczxczxc";
    ...
    public class Mcblock_change_me extends BlockBase {
        public Mcblock_change_me() {
            super(BLOCK_ID, CREATIVE_TAB, "change_me", Material.ground);
        }

        @Override
        public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hx, float hy, float hz) {
                world.setWorldTime(Math.max(0, (long)0));
            return true;
        }
    }
