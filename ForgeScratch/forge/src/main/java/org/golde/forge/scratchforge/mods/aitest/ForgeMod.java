...
public class ForgeMod implements IWorldGenerator{
	...
	public static final String MOD_NAME = "aitest";
	public static final String MOD_ID = "sf_aitest";
	public static final String BLOCK_ID = MOD_ID + ":";
    public static final String MOD_PACKAGE = "org.golde.forge.scratchforge.mods.aitest";
