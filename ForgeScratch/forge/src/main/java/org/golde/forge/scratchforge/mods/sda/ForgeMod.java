...
public class ForgeMod implements IWorldGenerator{
	...
	public static final String MOD_NAME = "sda";
	public static final String MOD_ID = "sf_sda";
	public static final String BLOCK_ID = MOD_ID + ":";
    public static final String MOD_PACKAGE = "org.golde.forge.scratchforge.mods.sda";
