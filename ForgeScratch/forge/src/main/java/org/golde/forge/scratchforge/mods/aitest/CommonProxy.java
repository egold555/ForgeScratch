...
public class CommonProxy {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		createEntity(Mcentity_Test.class, Mcentity_Test.RAW_NAME, Mcentity_Test.NAME, Mcentity_Test.EGG_P, Mcentity_Test.EGG_S); //Biped
	...
	public static class Mcentity_Test extends EntityCreature {
		...
		public static final int EGG_P = 0x66ffff;
