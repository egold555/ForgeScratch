...
public class ForgeMod implements IWorldGenerator{
	...
	public static final String MOD_NAME = "Example - Item NBT";
	public static final String MOD_ID = "sf_example___item_nbt";
	public static final String BLOCK_ID = MOD_ID + ":";
    public static final String MOD_PACKAGE = "org.golde.forge.scratchforge.mods.example___item_nbt";
