package org.golde.forge.scratchforge.mods.example___item_nbt;
...
public class CommonProxy {
	...
	static Mcitem_Counter mcitem_Counter;
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mcitem_Counter = new Mcitem_Counter();
...
/*type:item*/
    public class Mcitem_Counter extends ItemBase {
        public Mcitem_Counter() {
            super(ForgeMod.BLOCK_ID, ForgeMod.CREATIVE_TAB, "Counter", 1);
        }
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer player){
        ...
        if (itemstack.hasTagCompound()){variableHolder.nbt = itemstack.getTagCompound();}else{variableHolder.nbt = new NBTTagCompound(); itemstack.setTagCompound(variableHolder.nbt);}
            variableHolder.nbt.setDouble("counter", (((itemstack.getTagCompound() != null ? itemstack.getTagCompound().getDouble("counter") : 0)) + 1));
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer p_77624_2_, List lores, boolean p_77624_4_) {
        lores.add(("Count: " + ModHelpers.getChatColorFromHex("#55ff55") + (itemstack.getTagCompound() != null ? itemstack.getTagCompound().getDouble("counter") : 0)));
    }
    }
