...
public class ForgeMod implements IWorldGenerator{
	...
	public static final String MOD_NAME = "eric's mod";
	public static final String MOD_ID = "sf_eric_s_mod";
	public static final String BLOCK_ID = MOD_ID + ":";
    public static final String MOD_PACKAGE = "org.golde.forge.scratchforge.mods.eric_s_mod";
