...
public class CommonProxy {
	...
	/* Block Variables */
	static Mcblock_Testing mcblock_Testing;
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mcblock_Testing = new Mcblock_Testing();
...
/*type:block*/
    public class Mcblock_Testing extends BlockBase {
        public Mcblock_Testing() {
            super(ForgeMod.BLOCK_ID, ForgeMod.CREATIVE_TAB, "Testing", Material.ground);
    ...
    setResistance(6000000.0F);
        ...
        public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hx, float hy, float hz) {
             ...
             final VariableHolder variableHolder = new VariableHolder();
                world.setBlock((int)(x), (int)(y), (int)(z), (Blocks.acacia_stairs), 0, 3);
