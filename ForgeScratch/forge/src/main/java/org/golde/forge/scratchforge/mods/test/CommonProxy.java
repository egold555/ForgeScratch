...
public class CommonProxy {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		createEntity(Mcentity_Chiocken.class, Mcentity_Chiocken.RAW_NAME, Mcentity_Chiocken.NAME, Mcentity_Chiocken.EGG_P, Mcentity_Chiocken.EGG_S); //Chicken
	...
	public void serverLoad(FMLServerStartingEvent event) {
		/* Command Registry */
		event.registerServerCommand(new Mccommand_Eric());
...
/*type:command*/
    public class Mccommand_Eric extends AbstractCommand {
           @Override
           ...
           public void run(EntityPlayer player, String[] args) {
                 ...
                 if(world.isRemote){return;}
                     if(player != null) {player.addChatMessage(new ChatComponentText((ModHelpers.getChatColorFromHex("#55ff55").toString() + "Hello!")));}
...
/*type:entity*/
/*model:Chicken*/
public static class Mcentity_Chiocken extends EntityCreature {
    public static final String RAW_NAME = "Chiocken";
    public static final String NAME = "Chiocken";
    public static final boolean SPAWN_NATURALLY = false;
    public static final int EGG_P = 0xffff33;
    public static final int EGG_S = 0x3366ff;

    public Mcentity_Chiocken(World world){
        super(world);
    }

            /*scalex:10*/ /*scaley:5*/ /*scalez:7*/
