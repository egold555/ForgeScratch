...
public class CommonProxy {
	...
	public void serverLoad(FMLServerStartingEvent event) {
		/* Command Registry */
		event.registerServerCommand(new Mccommand_PlaceRandomBlocks());
 ...
 * @return int
 */
public static int math_random_int(double a, double b) {
  a = (int)a;
  b = (int)b;
  if (a > b) {
...
/*type:command*/
    public class Mccommand_PlaceRandomBlocks extends AbstractCommand {
           @Override
           public String getCommandName() {
                 return "PlaceRandomBlocks";
           }
        ...
        world.setBlock((int)(math_random_int(player.posX, (player.posX) + 20)), (int)(math_random_int(player.posY, (player.posY) + 20)), (int)(math_random_int(player.posZ, (player.posZ) + 20)), (Blocks.brown_mushroom), 0, 3);
    } // end for
