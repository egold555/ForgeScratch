package org.golde.forge.scratchforge.mods.example___rainbow_cube;
...
public class CommonProxy {
	...
	/* Block Variables */
	static Mcblock_Rainbow_Cube mcblock_Rainbow_Cube;
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mcblock_Rainbow_Cube = new Mcblock_Rainbow_Cube();
...
/*type:block*/
    public class Mcblock_Rainbow_Cube extends BlockBase {
        public Mcblock_Rainbow_Cube() {
            super(ForgeMod.BLOCK_ID, ForgeMod.CREATIVE_TAB, "Rainbow Cube", Material.ground);
