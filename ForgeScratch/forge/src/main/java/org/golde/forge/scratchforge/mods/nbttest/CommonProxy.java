package org.golde.forge.scratchforge.mods.nbttest;
...
public class CommonProxy {
	...
	static Mcitem_Item_Name mcitem_Item_Name;
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mcitem_Item_Name = new Mcitem_Item_Name();
...
/*type:item*/
    public class Mcitem_Item_Name extends ItemBase {
        public Mcitem_Item_Name() {
            super(ForgeMod.BLOCK_ID, ForgeMod.CREATIVE_TAB, "Item Name", 64);
        }
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer player){
        ...
        if (itemstack.hasTagCompound()){variableHolder.nbt = itemstack.getTagCompound();}else{variableHolder.nbt = new NBTTagCompound(); itemstack.setTagCompound(variableHolder.nbt);}
            variableHolder.nbt.setDouble("Test", (1 + ((itemstack.getTagCompound() != null ? itemstack.getTagCompound().getDouble("Test") : 0))));
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer p_77624_2_, List lores, boolean p_77624_4_) {
        lores.add(("Clicks: " + (itemstack.getTagCompound() != null ? itemstack.getTagCompound().getDouble("Test") : 0)));
    }
    }
